package br.newtonpaiva.av2.microempresa.domain;
...
public class MicroEmpresa {
	...
	/*Não possuo o lombok nesta máquina que estou utilizando, 
		então irei criar os construtores e getters/setters 
		manualmente.
	*/ 
	public MicroEmpresa() {
	}
